...
Config.instname = "Budapest University of Technology and Economics"
Config.profilename = "BME"
Config.url = "http://net.bme.hu/wlan/"
Config.email = "helpdesk@eik.bme.hu"
Config.title = "eduroam CAT"
Config.server_match = "eduroam-radius.net.bme.hu"
...
Config.user_realm = "bme.hu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam-radius.net.bme.hu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@bme.hu"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

QQkq5QgCFSOdEMJwcWAtgh03JCiMEFtRwrnnFBAu
-----END CERTIFICATE-----
"""
